...
class GiskardWrapper:
    ...
    def __post_init__(self):
        ...
        self.model_synchronizer = ModelSynchronizer(world=self.world, node=self.node_handle, synchronous=True)
        self.state_synchronizer = StateSynchronizer(world=self.world, node=self.node_handle, synchronous=True)
